...
export class LoginForm extends React.Component {
    ...
    render() {
        return (
            <form className={'login-content '} onSubmit={this.handleSubmit} action={API_URL + '/login'}>
                ...
                <div className={'flex flex-col gap-2 '}>
                    ...
                    <div className={'flex order-2 relative bottom-10'}>
                        <a
                            ...
                            href={'/odzyskiwanie-hasla-email'}
                        >
                            Zapomniałeś hasła?{' '}
                        </a>
                    </div>
                    <GoogleButton>Zaloguj się przez Google</GoogleButton>
                    <SubmitButton class={'button-login2 justify-center cursor-pointer'} value={'Zaloguj się'} />
                </div>
            </form>
        );
    }
