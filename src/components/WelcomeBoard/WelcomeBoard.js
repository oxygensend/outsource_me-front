                ...
                <div className={'right-content'}>
                    <HomeContent>
                        <div className={'home-title'}>
                            <p>Znajdź dodatkowe źródła</p>
                        </div>
                        <div className={'home-paragraph'}>
                            {!this.state.isAuthenticated ? (
                                <p>
                                    Witaj w <b>Outsource me</b> - aplikacji dla programistów. Znajdź zlecenia, rozwijaj
                                    kariery. Dołącz do nas już dziś!
                                </p>
                            ) : (
                                <>
                                    <p className={'mb-6'}>
                                    ...
                                    <ButtonLink route={'/oferty-zlecen'} value={'Nasze oferty'} />
                                </>
                            )}
                        </div>
                        {!this.state.isAuthenticated ? (
                            <div className={' mt-20 sm:grid-cols-6 sm:gap-4 sm:flex  sm:mb-24 sm:ml-10'}>
                                <ButtonLink
                                    class={'button-login justify-center '}
                                    text_color={'#000000'}
                                    value={'Zaloguj się'}
                                    route={'/logowanie'}
                                />
                                <ButtonLink
                                    class={'button-sign-in justify-center'}
                                    value={'Dołącz do nas'}
                                    route={'/rejestracja'}
                                />
                            </div>
