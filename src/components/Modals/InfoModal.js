        ...
        <ModalWrapper title={title} setShowModals={setShowModals} prop={prop} type={'info'}>
            ...
            <div className={'flex flex-col gap-1'}>
                <div className={'flex flex-row gap-2'}>
                    <img className={'mt-0.5'} src={mail} alt={'mail'} width={16} height={16} />
                    <p
                ...
                <div className={'flex flex-row gap-2 '}>
                    ...
                    <a href={personalData.linkedinUrl} className={'text-blue-500  hover:underline cursor-pointer'}>
                        Linkedin{' '}
                    </a>
                </div>
                <div className={'flex flex-row gap-2'}>
                    <img className={'mt-1'} src={phone} alt={'phone'} style={{ maxHeight: '16px' }} />
