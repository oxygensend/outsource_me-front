...
export const UserSmallCard = ({ user, className }) => {
    return (
        <div className={'job-offer ' + className ?? null}>
            ...
            <div className={'grid grid-cols-12 mt-5 md:mt-0 md:flex md:flex-row md:justify-between md:ml-8 md:mr-8 '}>
                <div className={'application-font col-start-2  col-span-6'}></div>
