            ...
            <div className={'box-wrapper'}>
                <div>
                    ...
                    {application.description ? (
                        <p
                            className={
                                'text-blue-500 text-lg font-bold mt-4 hover:underline hover:text-blue-400 cursor-pointer'
                            }
                        ...
                        <p className={'text-blue-500 text-lg font-bold mt-4'}>Brak wiadomości</p>
                    )}
                </div>
                {
                    <Button
