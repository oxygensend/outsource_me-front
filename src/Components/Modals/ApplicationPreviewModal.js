    ...
    if (selectedApplication) {
        ...
        return (
            ...
            >
                ...
                <p className={"text-sm italic font-gray pl-2"}>{selectedApplication.description ?? 'Brak wiadomości'}</p>

                <p className={"text-red-700 text-lg font-bold mt-4"}>Dołączone pliki</p>
                {selectedApplication.attachments ? selectedApplication.attachments.map((file, i) => {
                        return (
