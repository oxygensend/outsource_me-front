...
export const PrincipleApplicationCard = ({application, id, onClickReject, onClickAccept}) => {
    ...
    return (
        <div key={id}
             className={'application flex justify-between mb-4 ' + (application.status === 1 ? 'application-active' : 'application-deactivated')}>
            <div>
                ...
                <div className={"flex flex-row gap-2 mt-4"}>
                    ...
                    <p className={"font-time italic bottom-0.5 relative"}>Przesłano {moment(application.createdAt).fromNow()} </p>
